...
add_test(
    NAME "cargo-test"
    COMMAND env ${VARS_FOR_CARGO} sh -c ". ${CMAKE_CURRENT_BINARY_DIR}/tests/test_env.sh;
    cargo test ${CARGO_FLAGS} --package fish --target-dir ${rust_target_dir} ${cargo_test_flags}"
